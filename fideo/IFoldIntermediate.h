...
public:
     ...
     * @return void
     */
    virtual void foldTo(const biopp::NucSequence& seqRNAm, const bool isCircRNAm, biopp::SecStructure& structureRNAm, const FilePath& outputFile, const Temperature temp);
     ...
     * @return void
     */
    virtual void foldTo(const biopp::NucSequence& seqRNAm, const bool isCircRNAm, biopp::SecStructure& structureRNAm, const FilePath& outputFile, IMotifObserver* motifObserver, const Temperature temp) = 0;
...
private:
     ...
     * @return void
     */
    void commonFold(const biopp::NucSequence& sequence, const bool isCirc, const Temperature temp, biopp::SecStructure& structure, InputFile& inputFile, OutputFile& outputFile);
     ...
     * @return void
     */
    virtual void prepareData(const biopp::NucSequence& sequence, const bool isCirc, etilico::Command& command, InputFile& inputFile, OutputFile& outputFile) = 0;
