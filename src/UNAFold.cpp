...
void UNAFold::deleteAllFiles(const std::string& nameFile)
{
    ...
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".ct").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + "_1.ct").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".dG").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".h-num").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".rnaml").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".plot").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".run").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".ss-count").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".ann").c_str()) == 0);
    mili::assert_throw<ExceptionUnlink>(unlink((nameFile + ".det").c_str()) == 0);
}
