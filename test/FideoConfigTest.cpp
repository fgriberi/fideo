...
TEST(FideoConfigTestSuite, Test1)
{
    ...
    const std::string executablePath =  FideoConfig::getPath(INTA_RNA);
...
TEST(FideoConfigTestSuite, Test2)
{
    ...
    const std::string executablePath =  FideoConfig::getPath(RUN_GENE_DESIGN);
...
TEST(FideoConfigTestSuite, Test3)
{
    ...
    const std::string executablePath =  FideoConfig::getPath(RESULT_GENE_DESIGN);
